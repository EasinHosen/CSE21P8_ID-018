...
public class Weight extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        From.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Kilogram", "Gram", "Pounds" }));
        ...
        To.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Kilogram", "Gram", "Pounds" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (From.getSelectedItem().toString() == "Kilogram" && To.getSelectedItem().toString() == "Kilogram") {
            ca = amount;
            b.setText(String.format("%.3f kg", ca));
        } else if (From.getSelectedItem().toString() == "Kilogram" && To.getSelectedItem().toString() == "Gram") {
            ca = amount * 1000;

            b.setText(String.format("%.3f g", ca));
        } else if (From.getSelectedItem().toString() == "Kilogram" && To.getSelectedItem().toString() == "Pounds") {
            ca = amount * 2.204623;

            b.setText(String.format("%.3f pounds", ca));
        } else if (From.getSelectedItem().toString() == "Gram" && To.getSelectedItem().toString() == "Kilogram") {
            ca = amount / 1000;

            b.setText(String.format("%.3f kg", ca));
        } else if (From.getSelectedItem().toString() == "Gram" && To.getSelectedItem().toString() == "Gram") {
            ca = amount;

            b.setText(String.format("%.3f g", ca));
        } else if (From.getSelectedItem().toString() == "Gram" && To.getSelectedItem().toString() == "Pounds") {
            ca = ((amount / 1000) * 2.204623);

            b.setText(String.format("%.3f pounds", ca));
        } else if (From.getSelectedItem().toString() == "Pounds" && To.getSelectedItem().toString() == "Kilogram") {
            ca = amount / 2.204623;

            b.setText(String.format("%.3f kg", ca));
        } else if (From.getSelectedItem().toString() == "Pounds" && To.getSelectedItem().toString() == "Pounds") {
            ca = amount;

            b.setText(String.format("%.3f pounds", ca));
        } else if (From.getSelectedItem().toString() == "Pounds" && To.getSelectedItem().toString() == "Gram") {
            ca = ((amount / 2.204623) * 1000);
